...
namespace FF1Lib
{
	...
	public partial class FF1Rom : NesRom
	{
		...
		{
			/////////////////DEBUG SETTING///////////////////
			flags.progScaling = ProgressiveScaling.ThresholdFull;
			/////////////////DEBUG SETTING///////////////////
			...
			if (flags.progScaling != ProgressiveScaling.None)
			{
			...
			ExtraTrackingAndInitCode(flags.progScaling);
		}
		private void ExtraTrackingAndInitCode(ProgressiveScaling progScaling)
		{
			 ...
			 *	Key Items       $60B8 (8-bit)
			*/

			// Patches for various tracking variables follow:
			// Pedometer + chests opened
			//PutInBank(0x0F, 0x8100, Blob.FromHex("18A532D027A52D2901F006A550D01DF00398D018ADA06069018DA060ADA16069008DA160ADA26069008DA260A52F8530A9FF8518A200A000BD00622904F001C8E8D0F5988DB76060"));
			PutInBank(0x0F, 0x8100, Blob.FromHex("18A532D027A52D2901F006A550D01DF00398D018ADA06069018DA060ADA16069008DA160ADA26069008DA260A52F8530A9FF8518A200A000BD00622904F001C8E8D0F5988DB76020009060"));
			...
			//string dynProgScalingStr = $"200090A9{ScaleFactor:X2}851FAD78688510AD79688511A51F851220C090ADB860F047AAAD786865108D7868AD796865118D7968CAD0ED18AD76688510AD77688511A51F851220C090ADB860AAAD766865108D7668AD776865118D7768CAD0EDAD76688588AD77688589A91C8580A960858160"
			//progressive scaling using a dynamic scaling factor specified by the above variable
			//PutInBank(0x0F, 0x9100, Blob.FromHex($"200090A9{ScaleFactor:X2}851FAD78688510AD79688511A51F851220C090ADB860F047AAAD786865108D7868AD796865118D7968CAD0ED18AD76688510AD77688511A51F851220C090ADB860AAAD766865108D7668AD776865118D7768CAD0EDAD76688588AD77688589A91C8580A960858160"));
			//Threshold - 12 items, 25 % boost
			//200090ADB860C90C904FAD78688510AD796885114611661046116610AD786865108D7868AD796865118D796818AD76688510AD776885114611661046116610AD766865108D7668AD776865118D7768AD76688588AD77688589A91C8580A960858160
			//Threshold - 12 items, 50 % boost
			//200090ADB860C90C9047AD78688510AD7968851146116610AD786865108D7868AD796865118D796818AD76688510AD7768851146116610AD766865108D7668AD776865118D7768AD76688588AD77688589A91C8580A960858160
			//Threshold - 12 items, double boost
			//200090ADB860C90C903FAD78688510AD79688511AD786865108D7868AD796865118D796818AD76688510AD77688511AD766865108D7668AD776865118D7768AD76688588AD77688589A91C8580A960858160
			if (progScaling != ProgressiveScaling.None)
			{
				string HexBlob = "";
				byte ScaleFactor = 1;
				switch (progScaling)
				{
					case ProgressiveScaling.ThresholdQuarter:
						HexBlob = "200090ADB860C90C904FAD78688510AD796885114611661046116610AD786865108D7868AD796865118D796818AD76688510AD776885114611661046116610AD766865108D7668AD776865118D7768AD76688588AD77688589A91C8580A960858160";
						break;
					case ProgressiveScaling.ThresholdHalf:
						HexBlob = "200090ADB860C90C9047AD78688510AD7968851146116610AD786865108D7868AD796865118D796818AD76688510AD7768851146116610AD766865108D7668AD776865118D7768AD76688588AD77688589A91C8580A960858160";
						break;
					case ProgressiveScaling.ThresholdFull:
						HexBlob = "200090ADB860C90C903FAD78688510AD79688511AD786865108D7868AD796865118D796818AD76688510AD77688511AD766865108D7668AD776865118D7768AD76688588AD77688589A91C8580A960858160";
						break;
					case ProgressiveScaling.DynamicSlow:
						ScaleFactor = 20;
						HexBlob = $"200090A9{ScaleFactor:X2}851FAD78688510AD79688511A51F851220C090ADB860F047AAAD786865108D7868AD796865118D7968CAD0ED18AD76688510AD77688511A51F851220C090ADB860AAAD766865108D7668AD776865118D7768CAD0EDAD76688588AD77688589A91C8580A960858160";
						break;
					case ProgressiveScaling.DynamicAverage:
						ScaleFactor = 10;
						HexBlob = $"200090A9{ScaleFactor:X2}851FAD78688510AD79688511A51F851220C090ADB860F047AAAD786865108D7868AD796865118D7968CAD0ED18AD76688510AD77688511A51F851220C090ADB860AAAD766865108D7668AD776865118D7768CAD0EDAD76688588AD77688589A91C8580A960858160";
						break;
					case ProgressiveScaling.DynamicFast:
						ScaleFactor = 5;
						HexBlob = $"200090A9{ScaleFactor:X2}851FAD78688510AD79688511A51F851220C090ADB860F047AAAD786865108D7868AD796865118D7968CAD0ED18AD76688510AD77688511A51F851220C090ADB860AAAD766865108D7668AD776865118D7768CAD0EDAD76688588AD77688589A91C8580A960858160";
						break;
				}
			...
			//threshold scaling method, currently set to add 50% after 12 key items:
			//PutInBank(0x0F, 0x9100, Blob.FromHex("200090ADB860C90C9047AD78688510AD7968851146116610AD786865108D7868AD796865118D796818AD76688510AD7768851146116610AD766865108D7668AD776865118D7768AD76688588AD77688589A91C8580A960858160"));
			//Division routine
